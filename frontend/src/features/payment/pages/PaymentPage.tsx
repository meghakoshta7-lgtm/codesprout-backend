...
import {
  usePaymentInit, usePaymentVerify, usePaymentStatus,
...
const STEPS_RAZORPAY = ['Pay', 'Verify'] as const;
...
export default function PaymentPage() {
  ...
  const { enabled: razorpayEnabled, loading: razorpayLoading } = useRazorpayStatus();
  ...
  if (razorpayEnabled && !razorpayLoading) {
    return (
